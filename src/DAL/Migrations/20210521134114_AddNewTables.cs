    ...
    public partial class AddNewTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 26, 1, "Sam Raiden", "Software developer", null });

            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "Id", "Age", "CompanyId", "Name", "Position", "UserId" },
                values: new object[] { 2, 30, 1, "Jana McLeaf", "Software developer", null });

            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "Id", "Age", "CompanyId", "Name", "Position", "UserId" },
                values: new object[] { 3, 35, 2, "Kane Miller", "Administrator", null });
